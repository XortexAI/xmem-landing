      ...
      <main className="container mx-auto px-4 pt-32 pb-16 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            Convert chat threads and coding-agent transcripts from ChatGPT, Claude, Gemini, Cursor, Antigravity, Claude Code, and Gemini CLI into compressed, usable memories.
          </p>
          {user?.username && (
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="text-xs text-white/40">Supported: Cursor, Antigravity, Claude Code, and Gemini CLI exports (.txt, .md, .json, .jsonl)</p>
                          </div>
                          <Input
                            id="file-upload"
                            type="file"
